...
#SENSITIVITY ANALYSIS 2...CHANGE COST OF DAB TREATMENT
...
#CHANGE COST OF DAB TO 1800--FOLLOWING VALUE GIVEN IN SENS ANALYSIS OF COST IN THE PAPER
# annual drug costs per year
ASPIRIN_COST = 10.0
DUAL_COST= 1857.0
WARFARIN_COST = 180
DABIGATRAN_COST = 1800.0
