...
def report_CEA_CBA(simOutputs_Dabigitran150, simOutputs_warfarin):
    Dabigitran150_therapy_strategy = Econ.Strategy(name="Warfarin therapy", cost_obs=simOutputs_warfarin.get_costs(),
                                                   effect_obs=simOutputs_warfarin.get_utilities())
    warfarin_therapy_strategy = Econ.Strategy(name="Dabigitran150 therapy",
